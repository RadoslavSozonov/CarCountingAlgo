...
Requirements:
    $ pip install -r requirements2.txt coremltools onnx onnx-simplifier onnxruntime openvino-dev tensorflow-cpu  # CPU
    $ pip install -r requirements2.txt coremltools onnx onnx-simplifier onnxruntime-gpu openvino-dev tensorflow  # GPU

Usage:
    $ python path/to/export.py --weights yolov5s.pt --include torchscript onnx openvino engine coreml tflite ...

Inference:
    $ python path/to/app.py --weights yolov5s.pt                 # PyTorch
...
def run(
    ...
    if any(f):
        ...
        LOGGER.info(f'\nExport complete ({time.time() - t:.2f}s)'
                    ...
                    f"\nDetect:          python app.py --weights {f[-1]} {h}"
